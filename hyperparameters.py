...
hp_basic_test = HyperParametersTest(scenario='basic', agent='DDRQN',
...
hp_d_cor_test = HyperParametersTest(scenario='deadly_corridor', agent='DDRQN',
...
hp_def_c_test = HyperParametersTest(scenario='defend_the_center', agent='DDRQN',
                                    test_skiprate=1, epsilon=0.01, n_episodes=5)

# Health Gathering
hp_h_gth_train = HyperParametersTrain(scenario='health_gathering', agent='Distributional', cuda=True,
                                      train_skiprate=4, test_skiprate=1,
                                      replay_size=10 ** 5, screen_size=(3, 60, 108),
                                      learning_rate=0.0002,
                                      n_epoch=21, steps_per_epoch=8000, play_steps=15,
...
hp_h_gth_test = HyperParametersTest(scenario='health_gathering', agent='DDRQN',
                                    test_skiprate=1, epsilon=0.01, n_episodes=5)
