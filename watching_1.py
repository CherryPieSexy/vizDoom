...
from hyperparameters import hp_basic_test as hp_b
from hyperparameters import hp_def_c_test as hp_d
from hyperparameters import hp_h_gth_test as hp_h

if __name__ == '__main__':
    print('---------------------------- vizDoom watching script ---------------------------')

    for hp in [hp_b, hp_d, hp_h]:
